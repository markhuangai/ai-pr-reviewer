...
- The action writes assistant text, agent tool calls, and MCP inputs/results to the GitHub Actions log as secret-redacted previews capped at 200 characters, followed by the original payload length. Hidden model reasoning is not logged.
